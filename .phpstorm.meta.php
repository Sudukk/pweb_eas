...
namespace PHPSTORM_META {
    ...
    // Custom: auth() returns AuthFactory|Guard, so Intelephense can't see id()/user().
    // Force it to the concrete guard. Re-add this if you regenerate the meta file.
    override(\auth(0), type(\Illuminate\Contracts\Auth\StatefulGuard::class));
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\pweb-peminjaman-alat\public\storage' => 'string',
...
'filesystems.links.C:\\xampp\\pweb-peminjaman-alat\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified','role',);
        registerArgumentsSet('routes', 'register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','dashboard','profile.edit','profile.update',
'profile.destroy','notifikasi.index','notifikasi.recent','notifikasi.baca-semua','admin.dashboard',
'admin.alat.index','admin.alat.create','admin.alat.store','admin.alat.show','admin.alat.edit',
'admin.alat.update','admin.alat.destroy','admin.peminjaman.index','admin.peminjaman.show','admin.peminjaman.approve',
'admin.peminjaman.reject','admin.peminjaman.kembali','admin.peminjaman.prosesKembali','admin.denda.index','admin.denda.lunas',
'admin.users.index','admin.users.unblacklist','admin.ruangan.index','admin.ruangan.create','admin.ruangan.store',
'admin.ruangan.edit','admin.ruangan.update','admin.ruangan.destroy','admin.booking-ruangan.index','admin.booking-ruangan.pengaturan',
'admin.booking-ruangan.show','admin.booking-ruangan.approve','admin.booking-ruangan.reject','dosen.dashboard','mahasiswa.dashboard',
'peminjaman.index','peminjaman.create','peminjaman.store','peminjaman.show','booking-ruangan.index',
'booking-ruangan.create','booking-ruangan.store','booking-ruangan.kursi-terpakai','booking-ruangan.show','booking-ruangan.batal',
'denda.index','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.alat.create','admin.alat.edit','admin.alat.index','admin.alat.show','admin.booking-ruangan.index',
'admin.booking-ruangan.show','admin.dashboard','admin.denda.index','admin.peminjaman.approval','admin.peminjaman.form-kembali',
'admin.peminjaman.index','admin.peminjaman.kembali','admin.peminjaman.pengembalian','admin.peminjaman.show','admin.ruangan._form',
'admin.ruangan.create','admin.ruangan.edit','admin.ruangan.index','admin.users.index','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'booking-ruangan.create','booking-ruangan.index','booking-ruangan.show','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.guest-layout','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.seat-map','components.secondary-button','components.status-badge','components.text-input','dashboard',
'dashboard.dosen','dashboard.mahasiswa','denda.index','layouts.app','layouts.guest',
'layouts.navigation','notifikasi.index','partials.barang-pinjam','peminjaman.create','peminjaman.index',
'peminjaman.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
...
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.xampp.pweb-peminjaman-alat.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
